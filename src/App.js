        ...
        return ( <
            ...
            render = {
                ...
                this.state.loading ? ( <
                    ...
                    Gallery pictures = { this.state.mountainResults }
                    query = "mountains" /
                    >
                )
            }
            ...
            render = {
                ...
                this.state.loading ? ( <
                    ...
                    Gallery pictures = { this.state.dogResults }
                    query = "dogs" / >
                )
            }
            /> <
            Route exact path = "/sunset"
            render = {
                () =>
                this.state.loading ? ( <
                    p > Loading... < /p>
                ) : ( <
                    Gallery pictures = { this.state.sunsetResults }
                    query = "sunset" / >
                )
            }
            />
            ...
            render = {
                ...
                this.state.loading ? ( <
                    ...
                    Gallery pictures = { this.state.results }
